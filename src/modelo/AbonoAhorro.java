...
public class AbonoAhorro {
    ...
    /**
     * @return the id_abono_ahorro
     */
    public int getId_abono_ahorro() {
        return id_abono_ahorro;
    }

    /**
     * @param id_abono_ahorro the id_abono_ahorro to set
     */
    public void setId_abono_ahorro(int id_abono_ahorro) {
        this.id_abono_ahorro = id_abono_ahorro;
    }
